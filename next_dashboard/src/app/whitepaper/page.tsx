    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="pt-24 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-2">
              {sections.map((section, i) => (
                <a
                  key={i}
                  href={`#${section.id}`}
                  className="text-gray-400 hover:text-purple-400 transition-colors py-1"
                >
                  {section.title}
                </a>
              ))}
          ...
          {/* Download Section */}
          <div className="card bg-gradient-to-r from-purple-900/30 to-pink-900/30 border-purple-500/30 text-center">
